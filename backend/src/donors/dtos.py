...
class DonorUpdateAvailability(BaseModel):
    """The Available/Unavailable toggle on the donor's home screen.

    A dedicated endpoint rather than a field on DonorUpdateProfile: `False` is
    the meaningful value here, and DonorUpdateProfile's "skip None, ignore
    omissions" handling exists precisely because it can't express that.
    """

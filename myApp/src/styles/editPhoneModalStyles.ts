...
export const editPhoneModalStyles = StyleSheet.create({
  ...
  countryCode: { width: 92, height: 52, borderRadius: 12, borderWidth: 1, borderColor: colors.crimsonBorder, backgroundColor: colors.surface, paddingHorizontal: 12, color: colors.text, fontSize: 15 },
  numberInput: { flex: 1, height: 52, borderRadius: 12, borderWidth: 1, borderColor: colors.crimsonBorder, backgroundColor: colors.surface, paddingHorizontal: 14, color: colors.text, fontSize: 15 },
